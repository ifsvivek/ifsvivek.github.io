...
1. Develop a program to solve simple computational problems using arithmetic expressions and use
...
1. Develop a program to find the reverse of a positive integer and check for palindrome or not. Display appropriate messages.
...
1. Introduce 1D Array manipulation and implement a Binary search.
...
1. Implement using functions to check whether the given number
...
1. Develop a program to introduce 2D Array manipulation and implement
...
1. Develop a Program to compute Sin(x) using Taylor series approximation.
...
1. Write functions to implement string operations such as
...
1.  Develop a program to sort the given set of numbers using Bubble sort.
...
1. Develop a program to find the square root of a given number N and executes
...
1. Implement structures to read, write, and compute average-marks and the students
...
1. Develop a program using pointers to compute the sum, mean and
